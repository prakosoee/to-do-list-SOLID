<x-app-layout>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-6">
            <form method="GET" action="{{ route('category.index') }}" class="w-full md:w-1/3 mb-4 md:mb-0 flex gap-2">
                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-100 dark:border-gray-700 dark:hover:bg-gray-800">
                        ...
                        <td class="py-3 px-6 text-center">
                            <div class="flex item-center justify-center">
                                ...
                                <!-- Tombol Delete -->
                                <form id="deleteCategoryForm-{{ $c->id }}" action="{{ route('category.destroy', $c->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <!-- Tombol Delete -->
                                    <button type="button" data-category-id="{{ $c->id }}" onclick="openModal(this)"
